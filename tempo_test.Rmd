...
ggplot(no2_df_final_sf[sample(nrow(no2_df_final_sf), 20000), ]) + 
  base_map(bbox_no2, increase_zoom = 4, basemap = 'mapnik') +
  geom_sf(aes(color = no2_ppm), alpha = 0.1) +
  scale_color_gradient2(low = 'green', mid = 'red', high = "red", 
                       limits = c(0, 34), na.value = NA, midpoint = 14)
```
